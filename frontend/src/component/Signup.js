    ...
    <Paper elevation={3} className={classes.body}>
      <Grid container direction="column" spacing={4} alignItems="center">
        ...
        <Grid item>
          ...
          >
            <MenuItem value="healthworker">Health worker</MenuItem>
            <MenuItem value="admin">Admin/Doctor</MenuItem>
          </TextField>
        </Grid>
        <Grid item>
          <TextField
        ...
        {signupDetails.type === "healthworker" ? (
          <>
            ...
            {/* <Grid item>
              <ChipInput
                ...
                label="Department"
                variant="outlined"
                helperText="Press enter to add department"
                onChange={(chips) =>
          ...
          <>
            <Grid item style={{ width: "100%" }}>
              <TextField
                label="Description (upto 250 words)"
                multiline
                rows={8}
                style={{ width: "100%" }}
                variant="outlined"
